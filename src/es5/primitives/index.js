...
const literals = [
  require("./string_definition"),
  require("./numeric_definition"),
  require("./identifier_definition"),
  require("./regular_expression_literal"),
];
...
module.exports = ast_node_table => {
  ...
  for (const literal of literals) {
    ast_node_table.register_node_definition(literal);
  }
};