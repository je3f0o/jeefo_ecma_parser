/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
* File Name   : new_expression_specs.js
...
describe("NewExpression", () => {
	var stmt = parser.parse("new Function(1,a,null)")[0],
	...
	it('Type should be "NewExpression"', function () {
	...
	it("Should be has end object", function () {
		...
		expect(stmt.end.index).toBe(22);
		expect(stmt.end.column).toBe(23);
		expect(stmt.end.virtual_column).toBe(23);
	});
});
