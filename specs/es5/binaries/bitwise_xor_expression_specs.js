/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
* File Name   : bitwise_xor_expression_specs.js
...
describe("BitwiseXorExpression", () => {
	...
	it('Type should be "BitwiseXorExpression"', function () {
		expect(expr.type).toBe("BitwiseXorExpression");
	});

	it('Precedence should be (8)', function () {
		expect(expr.precedence).toBe(8);
	});
