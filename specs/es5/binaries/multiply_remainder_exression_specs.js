/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
* File Name   : multiply_division_exression_specs.js
...
describe("Multiply,Remainder BinaryExpression", () => {
	...
	it('Precedence should be (14)', function () {
		expect(expr.precedence).toBe(14);
	});
