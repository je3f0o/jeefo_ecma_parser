/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
* File Name   : member_expression_specs.js
...
describe("MemberExpression", () => {
	...
	it('Is computed should be false', function () {
		expect(expr.is_computed).toBe(false);
	});
	...
	it("Should be has end object", function () {
		...
		expect(expr.end.index).toBe(13);
		expect(expr.end.column).toBe(14);
		expect(expr.end.virtual_column).toBe(14);
	});
});
