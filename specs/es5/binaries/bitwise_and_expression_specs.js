/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
* File Name   : bitwise_and_expression_specs.js
...
describe("BitwiseAndExpression", () => {
	...
	it('Type should be "BitwiseAndExpression"', function () {
		expect(expr.type).toBe("BitwiseAndExpression");
	});

	it('Precedence should be (9)', function () {
		expect(expr.precedence).toBe(9);
	});
