/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
* File Name   : bitwise_or_expression_specs.js
...
describe("BitwiseOrExpression", () => {
	...
	it('Type should be "BitwiseOrExpression"', function () {
		expect(expr.type).toBe("BitwiseOrExpression");
	});

	it('Precedence should be (7)', function () {
		expect(expr.precedence).toBe(7);
	});
