/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
* File Name   : bit_shift_expression_specs.js
...
describe("BitwiseShiftExpression", () => {
	...
	it('Type should be "BitwiseShiftExpression"', function () {
		expect(expr.type).toBe("BitwiseShiftExpression");
	});

	it('Precedence should be (12)', function () {
		expect(expr.precedence).toBe(12);
	});
