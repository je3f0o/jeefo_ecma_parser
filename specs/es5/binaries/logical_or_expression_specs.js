/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
* File Name   : logical_or_expression_specs.js
...
describe("LogicalOrExpression", () => {
	...
	it('Type should be "LogicalOrExpression"', function () {
		expect(expr.type).toBe("LogicalOrExpression");
	});

	it('Precedence should be (5)', function () {
		expect(expr.precedence).toBe(5);
	});
