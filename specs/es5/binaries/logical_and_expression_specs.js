/* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
* File Name   : logical_and_expression_specs.js
...
describe("LogicalAndExpression", () => {
	...
	it('Type should be "LogicalAndExpression"', function () {
		expect(expr.type).toBe("LogicalAndExpression");
	});

	it('Precedence should be (6)', function () {
		expect(expr.precedence).toBe(6);
	});
