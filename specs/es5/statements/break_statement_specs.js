...
describe("Break statement >", () => {
    describe("Valid cases >", () => {
        const valid_test_cases = [
            ...
            // {{{1 /* pre comment */ break /* id comment */ id /* post comment */;
            {
                code   : "/* pre comment */ break /* id comment */ id /* post comment */;",
                source : "/* pre comment */ break /* id comment */ id /* post comment */;",
                asi    : false,
        ...
        valid_test_cases.forEach(test_case => {
            describe(`Test against source text '${ test_case.source.replace(/\n/g, "\\n") }'`, () => {
                ...
                it("should be Break statement", () => {
                    expect(symbol.id).to.be("Break statement");
                });
